...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test12)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="altahrir/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="altahrir/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($altahrir = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='altahrir/form_edit.php?ID=".$altahrir['ID']."'>Edit</a>";
                    echo "<a href='altahrir/hapus.php?ID=".$altahrir['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
