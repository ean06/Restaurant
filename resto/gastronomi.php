...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test2)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="gastronomi/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="gastronomi/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($gastronomi = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='gastronomi/form_edit.php?ID=".$gastronomi['ID']."'>Edit</a>";
                    echo "<a href='gastronomi/hapus.php?ID=".$gastronomi['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
