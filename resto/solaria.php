...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test1)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="solaria/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="solaria/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($solaria = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='solaria/form_edit.php?ID=".$solaria['ID']."'>Edit</a>";
                    echo "<a href='solaria/hapus.php?ID=".$solaria['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
