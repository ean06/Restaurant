...
<body>
    <header>
        <div class="prof">
            <ul>
                <li>
                    ...
                    <ul class="down">
                        <li><a href="solaria.php"><ion-icon name="person-circle-outline"></ion-icon>&nbsp;&nbsp;HOME</a></li><br><br>
        ...
        <?php while($presto = mysqli_fetch_array($test6)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="zoku/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="zoku/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($zoku = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='zoku/form_edit.php?ID=".$zoku['ID']."'>Edit</a>";
                    echo "<a href='zoku/hapus.php?ID=".$zoku['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
