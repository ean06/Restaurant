...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test7)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="oniquaer/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="oniquaer/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($oniquaer = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='oniquaer/form_edit.php?ID=".$oniquaer['ID']."'>Edit</a>";
                    echo "<a href='oniquaer/hapus.php?ID=".$oniquaer['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
