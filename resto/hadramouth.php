...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test11)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="hadramout/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="hadramout/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($hadramout = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='hadramout/form_edit.php?ID=".$hadramout['ID']."'>Edit</a>";
                    echo "<a href='hadramout/hapus.php?ID=".$hadramout['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
