...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test10)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="aljazeerah/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="aljazeerah/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($aljazeerah = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='aljazeerah/form_edit.php?ID=".$aljazeerah['ID']."'>Edit</a>";
                    echo "<a href='aljazeerah/hapus.php?ID=".$aljazeerah['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
