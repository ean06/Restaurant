...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test3)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="mandala/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="mandala/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($mandala = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='mandala/form_edit.php?ID=".$mandala['ID']."'>Edit</a>";
                    echo "<a href='mandala/hapus.php?ID=".$mandala['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
