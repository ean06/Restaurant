...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test4)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="abuba/lispemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="abuba/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($abuba = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='abuba/form_edit.php?ID=".$abuba['ID']."'>Edit</a>";
                    echo "<a href='abuba/hapus.php?ID=".$abuba['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
