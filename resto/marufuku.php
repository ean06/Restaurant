...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test9)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="marufuku/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="marufuku/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($marufuku = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='marufuku/form_edit.php?ID=".$marufuku['ID']."'>Edit</a>";
                    echo "<a href='marufuku/hapus.php?ID=".$marufuku['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
