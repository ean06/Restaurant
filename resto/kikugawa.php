...
<body>
    <header>
        ...
        <?php while($presto = mysqli_fetch_array($test8)) ?>
    </header>
    <div class="container">
        <h1>USER PROFILE</h1>
        <div class="abc">
            ...
            <a href="kikugawa/listpemesanan.php">Riwayat pemesanan</a><br>
    ...
    <h1>DATA MENU</h1>
    <nav>
		<a href="kikugawa/form_tambah.php"><ion-icon name="person-add-outline"></ion-icon></a>
	</nav>
		...
		<tbody>
			<?php 
				...
				while($kikugawa = mysqli_fetch_array($query)){
                    ...
                    echo "<td>";
					echo "<a href='kikugawa/form_edit.php?ID=".$kikugawa['ID']."'>Edit</a>";
                    echo "<a href='kikugawa/hapus.php?ID=".$kikugawa['ID']."' onClick=\"return confirm('yakin?');\">Hapus</a>";
					echo "</tr>";
				}
