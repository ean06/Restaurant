...
$sql = "SELECT * FROM pdriver WHERE ID='$_GET[ID]'";
$query = mysqli_query($db, $sql);
$pdriver = mysqli_fetch_assoc($query);
...
<header>
    ...
    <form action="prosesedit.php" method="post">
        <p>
			...
			<input type="text" name="ID" placeholder="Masukkan ID" value="<?php echo $pdriver['ID'] ?>" />
		</p>
        <p>
			<label for="NAMA">NAMA : </label>
			<input type="text" name="NAMA" value="<?php echo $pdriver['NAMA'] ?>" />
            <hr>
		</p>
        <p>
			<label for="ALAMAT">ALAMAT : </label><br>
			<input class="oonnee" type="text" name="ALAMAT"  value="<?php echo $pdriver['ALAMAT'] ?>"></input>
            <hr>
		</p>
        <p>
			<label for="NOTELFON">NO TELEFON : </label><br>
			<input type="number" name="NOTELFON"  value="<?php echo $pdriver['NOTELFON'] ?>"/>
            <hr>
		</p>
        <p>
            <label for="PLATNO">NO POLISI : </label><br>
			<input type="text" name="PLATNO"  value="<?php echo $pdriver['PLATNO'] ?>"/>
            <hr>
		</p>
