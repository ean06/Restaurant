        ...
        <div class="onne">
            ...
            <p>
                ...
                <!-- <select name="KATEGORI">
                    <option name="KATEGORI" value="INDONESIAN FOOD">INDONESIAN FOOD</option>
                    <option name="KATEGORI" value="WESTERN FOOD">WESTERN FOOD</option>
                    <option name="KATEGORI" value="JAPANESE FOOD">JAPANESE FOOD</option>
                    <option name="KATEGORI" value="MIDDLE EASTERN FOOD">MIDDLE EASTERN FOOD</option>
                </select> -->
				<label><input class="tutu" type="radio" name="KATEGORI" value="INDONESIAN FOOD"/>INDONESIAN FOOD</label><br>
				<label><input class="tutu" type="radio" name="KATEGORI" value="WESTERN FOOD"/>WESTERN FOOD</label>
                <label><input class="tutu" type="radio" name="KATEGORI" value="JAPANESE FOOD"/>JAPANESE FOOD</label>
                <label><input class="tutu" type="radio" name="KATEGORI" value="MIDDLE EASTERN FOOD"/>MIDDLE EASTERN FOOD</label>
			</p>
