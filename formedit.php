...
$sql = "SELECT * FROM userprofile WHERE ID='$_GET[ID]'";
...
<header>
    ...
    <form action="prosesedit.php" method="post">
        <p>
			...
			<input type="text" name="ID" placeholder="Masukkan ID" value="<?php echo $userprofile['ID'] ?>" />
		</p>
        <p>
			<label for="NAMA">NAMA : </label>
			<input type="text" name="NAMA" value="<?php echo $userprofile['NAMA'] ?>" />
            <hr>
		</p>
        <p>
			<label for="ALAMAT">ALAMAT : </label><br>
			<input class="oonnee" type="text" name="ALAMAT"  value="<?php echo $userprofile['ALAMAT'] ?>"></input>
            <hr>
		</p>
        <p>
            <label for="EMAIL">EMAIL : </label><br>
			<input type="text" name="EMAIL"  value="<?php echo $userprofile['EMAIL'] ?>"/>
            <hr>
		</p>
        <p>
			<label for="NOTELFON">NO TELEFON : </label><br>
			<input type="number" name="NOTELFON"  value="<?php echo $userprofile['NOTELFON'] ?>"/>
            <hr>
		</p>
        <p>
